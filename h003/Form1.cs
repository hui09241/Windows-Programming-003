...
namespace h003
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            DoubleBuffered = true;
            timer1.Enabled = true;
            pictureBox1.Top = -3170; pictureBox1.Left = 300;
            pictureBox2.Top = 3600; pictureBox2.Left = 200;
            pictureBox6.Top = 3000; pictureBox6.Left = 150;
            pictureBox7.Top = 850; pictureBox7.Left = 125;
            pictureBox8.Top = 2150; pictureBox8.Left = 97;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            pictureBox1.Top += 10;
            sp.Play(); // 撥放 
            if (pictureBox1.Top == 30) { pictureBox1.Top = Firy; pictureBox2.Top = 3600; }
            if (pictureBox2.Left <= 0 || pictureBox2.Left + pictureBox2.Width >= pictureBox1.Width)
            { timer1.Stop(); pictureBox2.Image = pictureBox5.Image; }
            if (pictureBox1.Width >= 300)
            { pictureBox1.Width -= crandom.Next(4) + 2; }
